...
var frameHit : float =1.0f;
var transition : float = 1.0f;
...
function SetTarget(object: GameObject){
...
function CalculateIK()
{
	...
	var targetTemp = target.position;
	
	target.position = targetTemp*(animInfo.normalizedTime%1) + hand.position*(1.0f-animInfo.normalizedTime%1);	
